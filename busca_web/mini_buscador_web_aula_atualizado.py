# mini_buscador_web_aula_atualizado.py
# exemplo da aula: mini buscador web com texto, links, pagerank, hits, normalizacao e anti-spam
# a ideia é criar uma "web pequena" no próprio código e ver o ranking sendo melhorado
...
# paginas usadas no exemplo da aula
# cada pagina tem id, titulo, texto e links para outras paginas
...
docs = [
    ...
    },
    {
        "id": "C",
        "titulo": "Curso Java",
        "texto": "curso de java completo com orientação a objetos e exercícios",
        "links": ["A"]
    },
    {
        "id": "D",
        "titulo": "Guia de Estudos",
        "texto": "guia de estudos para aprender programação com links de cursos e apostilas",
        "links": ["B", "C", "E"]
    },
    {
        "id": "E",
        "titulo": "Apostila Python",
        "texto": "apostila gratuita de python com exemplos para iniciantes",
        "links": ["B"]
    },
    {
        "id": "F",
        "titulo": "Página Spam",
        "texto": "curso gratuito melhor curso grátis promoção clique agora python python python",
        "links": ["B", "E"]
    }
]
...
# consulta usada no exemplo da aula

consulta = "curso python gratuito"
...
# aqui eu defino antes quais paginas realmente respondem bem essa consulta
# nesse exemplo da aula, as boas sao B e E
...
# mostra em quais paginas cada palavra aparece
...
# ranking textual com tf-idf + cosseno
# aqui o sistema olha se o texto da pagina combina com a consulta
